                ...
                <?php foreach ($data->result() as $row) : ?>
                    <div class="blog-single-item ">
                        <div class="blog-img_block">
                            <img src="<?php echo base_url() . 'assets/images/berita/' . $row->tulisan_gambar; ?>" class="img-fluid" alt="blog-img">
                            <div class="blog-date">
                        ...
                        <div class="blog-tiltle_block">
                            ...
                            <div class="blog-icons">
                                <div class="blog-share_block d-flex justify-content-center">
                                    <button><a href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>">Selengkapnya</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
