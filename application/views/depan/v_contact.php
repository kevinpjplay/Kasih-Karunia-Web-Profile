                            ...
                            <div class="contact-address">
                                ...
                                ?>
                                    <div class="contact-details">
                                        ...
                                        <h6>Alamat</h6>
                                        <p><?php echo $konfig_alamat; ?></p>
                                        <!-- <p> Jl. Alfons Nisnoni No. 8 B  
                                        <br> Kel. Nunleu, Kec. Kota Raja
                                        <br> Kota Kupang, NTT</p> -->
                                    </div>
                                    <br>
                                    <div class="contact-details">
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h6>Email</h6>
                                        <p> <?php echo $konfig_email; ?>
                                        </p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
