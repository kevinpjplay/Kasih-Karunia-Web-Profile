...
<body>
  <header class="main-header">
    ...
    <a href="<?php echo base_url() . 'admin/dashboard' ?>" class="logo">
      ...
      <span class="logo-mini"><img style="width:45px; height:53px;" src="<?php echo base_url() . 'theme/images/logo.png' ?>"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img style="width:55px; height:50px;" src="<?php echo base_url() . 'theme/images/logo.png' ?>">Kasih Karunia</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url() . 'admin/buku_tamu' ?>">Lihat Semua Pesan</a></li>
            </ul>
          </li>
