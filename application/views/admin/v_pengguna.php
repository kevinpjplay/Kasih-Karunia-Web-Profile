...
<head>
    ...
    <title>Data Admin - TK Kasih Karunia</title>
...
<body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="box">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-user-plus"></span> Tambah Data</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-striped" style="font-size:13px;">
                                        ...
                                        <tbody>
                                            <?php foreach ($data->result_array() as $i) :
                                                ...
                                                $jenkel = $i['pengguna_jenkel'];
                                                $email = $i['pengguna_email'];
                                                $username = $i['pengguna_username'];
                                                $password = $i['pengguna_password'];
                                                $nohp = $i['pengguna_nohp'];
                                                $level = $i['pengguna_level'];
                                                $photo = $i['pengguna_photo'];
                                            ?>
                                                <tr>
                                                    <?php if (empty($photo)) : ?>
                                                        <td><img width="40" height="40" class="img-circle" src="<?php echo base_url() . 'assets/images/user_blank.png'; ?>"></td>
                                                    <?php else : ?>
                                                        <td><img width="40" height="40" class="img-circle" src="<?php echo base_url() . 'assets/images/admin/' . $photo; ?>"></td>
                                                    <?php endif; ?>
                                                    <td><?php echo $nama; ?></td>
                                                    ...
                                                    <td style="text-align:right;">
                                                        ...
                                                        <a class="btn btn-primary" href="<?php echo base_url() . 'admin/konfigurasi_admin/reset_password/' . $id; ?>"><span class="fa fa-refresh"></span></a>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'admin/konfigurasi_admin/simpan_pengguna' ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/konfigurasi_admin/update_pengguna' ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/konfigurasi_admin/hapus_pengguna' ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input type="hidden" name="kode" value="<?php echo $id; ?>" />
                            <input type="hidden" value="<?php echo $photo; ?>" name="gambar">
    ...
    <?php elseif ($this->session->flashdata('msg') == 'error-tambah') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Pemberitahuan',
                text: "Data admin gagal disimpan.",
                showHideTransition: 'slide',
                icon: 'error',
                hideAfter: false,
                position: 'bottom-right',
