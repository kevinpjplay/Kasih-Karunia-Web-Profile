...
<head>
  ...
  <title>Update Berita - TK Kasih Karunia Kupangt</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box box-default">
          ...
          $b = $data->row_array();
          ?>
          <form action="<?php echo base_url() . 'admin/berita/update_tulisan' ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-10">
                  ...
                  <input type="hidden" value="<?php echo $tulisan_gambar['tulisan_gambar']; ?>" name="gambar">
