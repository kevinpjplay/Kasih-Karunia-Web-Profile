...
<head>
  ...
  <title>Data Buku Tamu - TK Kasih Karunia</title>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Hapus Buku Tamu</h4>
          </div>
          <form class="form-horizontal" action="<?php echo base_url() . 'admin/buku_tamu/hapus_inbox' ?>" method="post" enctype="multipart/form-data">
