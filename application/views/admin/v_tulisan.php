...
<head>
  ...
  <title>Data List Berita - TK Kasih Karunia</title>
            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'admin/berita/add_tulisan' ?>"><span class="fa fa-plus"></span> Tambah Berita</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="text-align:right;">
                            <a class="btn btn-warning" href="<?php echo base_url() . 'admin/berita/get_edit/' . $tulisan_id; ?>"><span class="fa fa-pencil"></span></a>
                            <a class="btn btn-danger" data-toggle="modal" data-target="#ModalHapus<?php echo $tulisan_id; ?>"><span class="fa fa-trash"></span></a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $tulisan_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'admin/berita/hapus_tulisan' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $tulisan_id; ?>" />
              <input type="hidden" value="<?php echo $tulisan_gambar; ?>" name="gambar">
              <p>Apakah Anda yakin ingin menghapus Berita tentang <b><?php echo $tulisan_judul; ?></b> ?</p>
